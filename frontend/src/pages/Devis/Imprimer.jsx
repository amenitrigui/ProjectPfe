      ...
      <style>
        {`
          @media print {
            ...
            .mt-4 {
             uxTA}<t>                                      to="/Dev    isF className="border border-gray-300 px-2 py-1 text-sm"o
                            classNam    e=" className="border border-gray-300 px-2 py-1 text-sm"t
      ext-[#2a2185] 
                  hove"border border-gray-300 px-2 py-1 text-sm"           v cla          ← Retour    

ssName="border border-gray-300 px-2 py-1 text-sm"
                  00 px-2 py-1 text-sm"s
                  Rligne.QteART * emPUAT - -[#2a2185] pb-4 mb-6 gap-3">
              >

wflex flex-col lg:flex-row justify-beeen gap            {/oc TVA */}             divastlg:w1/3 p4 rounde-lg-[#2a2185]">
              <t className="table-auto -flpeo285nt TVf</old italic text-3xl">
                Ste Logicom - Progiciel de Gestion Intégrée ERP
              </h1>
    
px-2 py-1"ea  {devisInf.articles.tauxv}
                </td>
>ocsN TTCrder                2 className="text-2xl ixta py-1li
                  c" "}
                  {devisInff.aroicles
             ne.net-t || 0),
              xpy-1  texrder border-[#2a2185]">
          id                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="flex justify-center mt-6">
          <button
            type="button"
            className="text-white bg-[#2a2185] hover:bg-[#1f1a66] px-6 py-2 rounded-lgfocus:outlne-none"
            oClick={() => rectToP()}
          >
            <span clas            Impr          </button            <div className="text-right">
              <img
                src="logo.png"
