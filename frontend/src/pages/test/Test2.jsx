        ...
        <div className="flex space-x-4">
          ...
          {toolbarTable == "devis" && (
            ...
            <Link to="/Test1">
              <button
                type="button"
                className="flex items-center bg-[#2a2185] text-white px-4 py-2 rounded-md border border-[#2a2185] hover:bg-[#1f1a66] transition duration-200"
              >
                <PrinterIcon className="h-6 w-6 text-white mr-2" />
