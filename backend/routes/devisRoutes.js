...
const { getAllClients,getClientByCode, getClientByRsoc,getAllDevis,getLibpvByNumbl,getDevisWithDetails,getTotalDevis,getDevisCountByMonthAndYear,getDevisValidees,createDevis,getCodeRepAndRsRep,updateDevis,deleteDevis} = require('../controllers/devisController');
